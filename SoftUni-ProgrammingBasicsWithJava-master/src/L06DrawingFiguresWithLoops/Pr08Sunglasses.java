 ...
 */
public class Pr08Sunglasses {
    public static void main(String[] args) {
        Scanner scanner = new Scanner(System.in);
        int n = Integer.parseInt(scanner.nextLine());

        String starsSection = repeatStr("*", 2 * n);
        String glassSection = "*" + repeatStr("/", n * 2 - 2) + '*';
        String middleEmptySection = repeatStr(" ", n);
        String middleFrameSection = repeatStr("|", n);
